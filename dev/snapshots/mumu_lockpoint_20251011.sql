...
ALTER TABLE ONLY "public"."responses" FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY "public"."responses"
    ADD CONSTRAINT "responses_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;
